...
const exercises: Circuit[] = [
  {
    ...
    items: [
      ...
      { name: 'Arm Circles', duration: '30s each way', emoji: '💁‍♀️', image: SP('arm-circles'),
  ...
  },
  {
    ...
    items: [
      { name: 'Squats', duration: '40s ON / 20s REST', emoji: '🍑', image: SP('bodyweight-squat'),
      ...
      { name: 'Sumo Squats', duration: '40s ON / 20s REST', emoji: '🌺', image: SP('sumo-squat'),
      ...
      { name: 'Reverse Lunges', duration: '40s ON / 20s REST', emoji: '🦩', image: SP('reverse-lunge'),
      ...
      { name: 'Glute Bridges', duration: '40s ON / 20s REST', emoji: '🌸', image: SP('glute-bridge'),
      ...
      { name: 'Wall Sit', duration: 'Hold 40s', emoji: '🧘‍♀️', image: SP('wall-sit'),
  ...
  },
  {
    ...
    items: [
      { name: 'Push-Ups', duration: '40s ON / 20s REST', emoji: '💪', image: SP('push-up'),
      ...
      { name: 'Pike Push-Ups', duration: '40s ON / 20s REST', emoji: '🧚‍♀️', image: SP('pike-push-up'),
      ...
      { name: 'Tricep Dips', duration: '40s ON / 20s REST', emoji: '💗', image: SP('triceps-dip'),
      ...
      { name: 'Plank Hold', duration: 'Hold 40s', emoji: '🪷', image: SP('forearm-plank'),
      ...
      { name: 'Superman Hold', duration: '40s ON / 20s REST', emoji: '🦋', image: SP('superman'),
  ...
  },
  {
    ...
    items: [
      { name: 'Burpees', duration: '40s ON / 20s REST', emoji: '🔥', image: SP('burpee'),
      ...
      { name: 'Mountain Climbers', duration: '40s ON / 20s REST', emoji: '⛰️', image: SP('mountain-climbers'),
      ...
      { name: 'Jump Squats', duration: '40s ON / 20s REST', emoji: '🌟', image: SP('jump-squat'),
      ...
      { name: 'Lateral Shuffles', duration: '40s ON / 20s REST', emoji: '🦄', image: SP('lateral-shuffle'),
      ...
      { name: 'Squat to Kick', duration: '40s ON / 20s REST', emoji: '🌈', image: SP('squat-kick'),
  ...
  },
  {
    ...
    items: [
      { name: 'Crunches', duration: '30 sec', emoji: '🎀', image: SP('crunches'),
      ...
      { name: 'Bicycle Crunches', duration: '30 sec', emoji: '🚲', image: SP('bicycle-crunches'),
      ...
      { name: 'Leg Raises', duration: '30 sec', emoji: '🦵', image: SP('lying-leg-raise'),
      ...
      { name: 'Russian Twists', duration: '30 sec', emoji: '🌀', image: SP('russian-twist'),
      ...
      { name: 'Dead Bug Hold', duration: '30 sec', emoji: '🐞', image: SP('dead-bug'),
