...
const circuits: Circuit[] = [
  {
    ...
    items: [
      { name: 'Jumping Jacks', duration: '1 min', met: 8.0, minutes: 1, difficulty: 'Beginner', image: GIFS.jumpingJacks,
      ...
      { name: 'High Knees', duration: '1 min', met: 8.0, minutes: 1, difficulty: 'Beginner', image: GIFS.highKnees,
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Sumo Squats', duration: '40s ON / 20s REST', met: 5.0, minutes: 0.67, difficulty: 'Beginner', image: GIFS.sumoSquat,
      ...
      { name: 'Wall Sit', duration: 'Hold 40s', met: 4.0, minutes: 0.67, difficulty: 'Beginner', image: GIFS.wallSit,
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Pike Push-Ups', duration: '40s ON / 20s REST', met: 8.0, minutes: 0.67, difficulty: 'Intermediate', image: GIFS.pikePushUp,
      ...
      { name: 'Side Plank', duration: '30s per side', met: 3.5, minutes: 1, difficulty: 'Intermediate', image: GIFS.sidePlank,
  ...
  },
  {
    ...
    items: [
      { name: 'Burpees', duration: '40s ON / 20s REST', met: 10.0, minutes: 0.67, difficulty: 'Advanced', image: GIFS.burpees,
      ...
      { name: 'Squat to Kick', duration: '40s ON / 20s REST', met: 6.0, minutes: 0.67, difficulty: 'Beginner', image: GIFS.squatKick,
